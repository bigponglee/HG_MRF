function  [X_recon, para_maps_recon, SNR, Loss, process_time] = hge_solver(b, X_gt, Proj_D, A, At, AtA, P, P_t, dic_matching, para)
    % reconstruction using hypergraph embedding
    % Author: Peng Li
    % Date: 2025/06/08
    % 输入参数:
